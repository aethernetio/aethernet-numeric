...
using Bad = ae::seg::Compile<ae::seg::Format<
    ae::seg::runtime::Fixed<std::uint16_t>,
    ae::seg::wire::AutoTiered<std::uint8_t, ae::seg::wire::MaxBytes<1>>,
    ae::seg::compute::Formula,
    ae::seg::Layout<
        ae::seg::UniformStep<ae::seg::Range<D<0>, D<10>>, ae::seg::Step<D<1>>,
                             ae::seg::Place<ae::seg::Bytes<1>>>,
        ae::seg::UniformStep<ae::seg::Range<D<10>, D<20>>, ae::seg::Step<D<1>>,
                             ae::seg::Place<ae::seg::Bytes<1>>>,
        ae::seg::UniformStep<ae::seg::Range<D<10>, D<15>>, ae::seg::Step<D<1>>,
                             ae::seg::Place<ae::seg::Bytes<1>>>>>>;
